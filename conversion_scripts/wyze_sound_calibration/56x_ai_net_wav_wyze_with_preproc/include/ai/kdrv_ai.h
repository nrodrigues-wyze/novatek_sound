...
#define KDRV_AI_SUPPORT_NUELL           1
/********************************************************************
	TYPE DEFINITION
********************************************************************/
...
typedef struct _KDRV_AI_ROIPOOL_PARM {
	...
	KDRV_AI_OFS in_ofs;                         ///< input offset (line-offset, channel-offset, batch-offset)
	KDRV_AI_OFS out_ofs;                        ///< output offset (line-offset, channel-offset, batch-offset)
...
/**
    ...
    preproc structure
*/
typedef struct _KDRV_AI_PREPROC_INFO {
	UINT32 input_parm_pa;
	UINT32 input_parm_va;
	UINT32 input_parm_size;
	UINT32 eng_parm_pa;
	UINT32 eng_parm_va;
	UINT32 eng_parm_size;
} KDRV_AI_PREPROC_INFO;

/**
    KDRV AI structure
    fc structure
*/
typedef struct _KDRV_AI_FC_INFO {
	UINT32 input_parm_pa;
	UINT32 input_parm_va;
	UINT32 input_parm_size;
	UINT32 eng_parm_pa;
...
extern INT32 kdrv_ai_set_fc_ll_cmd(KDRV_AI_FC_INFO *p_fc_info);

extern UINT32 kdrv_ai_get_fc_cmd_size(UINT32 max_weight_h);

extern int kdrv_ai_is_fastboot(void);

extern int kdrv_ai_is_preload_model(void);

extern const CHAR *kdrv_ai_get_version(VOID);

#if defined(__FREERTOS)
INT32 kdrv_ai_drv_set_net_supported_num(UINT32 net_num);
#endif
#endif
