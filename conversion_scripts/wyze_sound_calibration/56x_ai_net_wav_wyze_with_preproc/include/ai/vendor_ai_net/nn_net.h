...
#define NN_CHIP_AI_SUBVER1_MASK			0x01
#define NN_CHIP_AI_SUBVER2_MASK			0x02
#define NN_CHIP_AI_SUBVER3_MASK			0x04
#define SUBVER_ILLEGAL_CHK_MASK			0x00
#define LEGAL_LSB						3
...
#define IN_BUF_NUM(p_mctrl)               (((p_mctrl)->mode==NN_DEPTHWISE || (p_mctrl)->mode==NN_CORR)? (((p_mctrl)->in_bufinfo_cnt&0xFFFF0000)>>16):((p_mctrl)->in_bufinfo_cnt))
#define IN_BUF_NUM_REAL(p_mctrl)          (((p_mctrl)->mode==NN_DEPTHWISE || (p_mctrl)->mode==NN_CORR)? (((p_mctrl)->in_bufinfo_cnt&0x0000FFFF)):((p_mctrl)->in_bufinfo_cnt))
...
#define OUT_BUF_NUM(p_mctrl)              (((p_mctrl)->mode==NN_DEPTHWISE || (p_mctrl)->mode==NN_CORR)? (((p_mctrl)->out_bufinfo_cnt&0xFFFF0000)>>16):((p_mctrl)->out_bufinfo_cnt))
#define OUT_BUF_NUM_REAL(p_mctrl)         (((p_mctrl)->mode==NN_DEPTHWISE || (p_mctrl)->mode==NN_CORR)? (((p_mctrl)->out_bufinfo_cnt&0x0000FFFF)):((p_mctrl)->out_bufinfo_cnt))
